            ...
            <div class="accordion accordion-minimal accordion-highlight" id="accordion-1">
              <div class="accordion-item">
                <h2 class="accordion-header" id="heading-1-1">
                  <button class="accordion-button fs-4 collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    Can i book for a session online?
                  </button>
                </h2>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="heading-1-2">
                  <button class="accordion-button fs-4 collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    Can i get a downloadable link for my pictures?
                  </button>
                </h2>
                <div id="collapse-1-2" class="accordion-collapse collapse" aria-labelledby="heading-1-2"
                  ...
                  <div class="accordion-body">
                    <p class="text-secondary">
                      <span class="fw-bold text-white">Yes.</span> All images you will be sent to your account on our website and also your email.
                    </p>
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="collapse-1-3" class="accordion-collapse collapse" aria-labelledby="heading-1-3"
                  ...
                  <div class="accordion-body">
                    ...
                    <a href="contact" class="btn btn-sm btn-with-icon btn-primary">Get in touch 
                        <i class="bi bi-arrow-right"></i>
                    </a>
                    <a href="#" onclick="tidioChatApi.open();" class="btn btn-sm btn-with-icon btn-outline-white">Chat wit us 
                        <i class="bi bi-arrow-right"></i>
                    </a>
                  </div>
                </div>
              ...
              <div class="accordion-item">
                ...
                <div id="collapse-1-4" class="accordion-collapse collapse" aria-labelledby="heading-1-4"
                  ...
                  <div class="accordion-body">
                    <p class="text-secondary">
                      <span class="fw-bold text-white">Yes.</span> All payments can be made online using Paystack secured gateway.
                    </p>
                  </div>
                </div>
              </div>

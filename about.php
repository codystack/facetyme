    ...
    <section class="overflow-hidden py-15 py-xl-20">
      <div class="container">
        <div class="row align-items-end mb-10 mt-5">
          ...
          <div class="col-lg-4 text-lg-end">
            <p class="fs-lg text-muted mb-1">Trusted by <span class="text-black">1k+</span> <span class="d-block">customers</span></p>
          </div>
        </div>
      </div>
      <div class="container gallery-1" data-aos="fade-up">
        <div class="row flex-nowrap align-items-end g-2 g-xl-5 mb-2 mb-xl-5"
          ...
          <div class="col-6 col-lg-5">
            <figure class="media equal equal-16-10 media-image" 
              data-bp='{"imgSrc": "./assets/images/about/1.png" , "parentGalleryClass": "gallery-1" }' >
              <span  style="background-image: url('./assets/images/about/1.png')">
              </span>
            </figure>
          </div>
          <div class="col-6 col-lg-5">
        ...
        <div class="row flex-nowrap align-items-start g-2 g-xl-5" data-bottom-top="transform: translateX(-50%)"
          ...
          <div class="col-6 col-lg-5">
            <figure class="media equal equal-16-10 media-image" 
              data-bp='{"imgSrc": "./assets/images/about/8.png" , "parentGalleryClass": "gallery-1" }' >
              <span  style="background-image: url('./assets/images/about/8.png')">
              </span>
            </figure>
          </div>
          <div class="col-6 col-lg-5">
